...
with tab1:
    ...
    st.markdown("""
    1. အောက်ပါအကွက်ထဲမှ **(Myanmar...ထုတ်‌ပေးပါ)**
       စာသားဘေးရှိ **Copy (ပုံလေး)** ကို နှိပ်ပါ။
    2. ထို့နောက် **"Google Gemini သို့သွားရန်"** ကို နှိပ်ပြီး 
       gemini ထဲတွင် + နှိပ်ပြီးvd ရွေးပါ ခုနကစာကို  paste လုပ်ပါ။

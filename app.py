...
with tab1:
    ...
    2. Gemini တွင် မိမိဘာသာပြန်လိုသော vdကို ထည့်ပါ။
    3. Gemini ကို အောက်ပါအတိုင်း ခိုင်းစေပါ -
       * *"အထက်ပါ vdကို မြန်မာလို ဘာသာပြန်ပေးပြီး SRT Format (timestamps ပါဝင်သော format) အဖြစ် ထုတ်ပေးပါ။"*
    4. Gemini မှ ထွက်လာသော SRT ကုဒ်များကို Copy ကူးယူပြီး အောက်ပါ အကွက်ထဲတွင် ထည့်ပါ။
    """)
